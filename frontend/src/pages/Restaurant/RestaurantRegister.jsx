...
export default function RestaurantRegister() {
    ...
    const submit = async (e) => {
        ...
        try{
            await api.post('/api/restaurants/register', form);
    ...
    return (
        <AuthLayout title ="Restaurant Register">
            <form onSubmit={submit}>
                ...
                <AuthInput label="Restaurant Name" value={form.name}
                ...
                <AuthInput label="Phone" value={form.phone}
                    onChange={(e) => setForm ({...form,phone: e.target.value})} />

                <AuthInput label="Address" value={form.address}
